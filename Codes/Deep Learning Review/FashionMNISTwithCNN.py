"""
Title : CNN(Convolutional Neural Network) Practice with Fashion MNIST Dataset
Date : July 18, 2021
Author : starrykss
"""
...
model.add(keras.layers.Conv2D(filters=32, kernel_size=(3, 3), activation='relu', input_shape=(28, 28, 1)))    # 2D Convolution
model.add(keras.layers.MaxPool2D(pool_size=(2, 2), strides=(2, 2)))                                           # Max Pooling
model.add(keras.layers.Conv2D(filters=64, kernel_size=(3, 3), activation='relu'))                             # 2D Convolution
model.add(keras.layers.MaxPool2D(pool_size=(2, 2), strides=(2, 2)))                                           # Max Pooling
